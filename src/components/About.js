...
const About = () => {
  ...
  return (
    <>
        <div className="mt-14 relative" id="About">
        ...
        <div className='flex flex-col relative md:flex-row ml-4 md:ml-36'>
          <div className="w-full md:w-80 mr-0 md:mr-16 mt-14">
            ...
            <button onClick={onButtonClick} type="submit" className='flex flex-row justify-center items-center absolute  w-24 h-24 px-3 bg-blu rounded-full text-para font-Dancing font-bold text-base' 
          ...
          <div className="l ml-0 md:ml-32 w-full md:w-10/12">
            <blockquote className="text-4xl font-thin mt-20 mb-36 " data-aos="flip-right">
