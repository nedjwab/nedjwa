...
const About = () => {
  ...
  return (
    <>
        ...
        <div className="relative mt-10 ml-52 flex flex-row">
          <div className="w-80 mr-16 mt-0 ">
            ...
            <button onClick={onButtonClick} type="submit" className='absolute  w-24 h-24 px-3 bg-blu rounded-full text-para font-Dancing'>
              Resume
            </button>
            </div>
          </div>
          <div className="l ml-40 w-10/12">
            <h1 className="text-4xl bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent  ">Who Am I</h1>
