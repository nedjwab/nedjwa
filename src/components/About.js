...
const About = () => {
  ...
  return (
    <>
      <div className="container about-section flex flex-row mt-20">
        <div className="ml-52 flex flex-row">
          ...
          <div className="l ml-40 w-10/12">
            ...
            <hr className="text-blu w-11 h-1 mt-2" />
            ...
            <div className="tech-container flex flex-row justify-between mb-40">
              <div className="w-1/3" data-aos="zoom-in">
                ...
                <div className="flex flex-row flex-wrap text-4xl mt-3">
                  <DiReact color="#A67153" fill="#A67153" className="mr-2" />
                  <DiJavascript1 className="mr-2"  />
                  <SiTailwindcss color="#A67153" fill="#A67153" className="mr-2" />
                  <SiBootstrap className="mr-2" />
                  <SiReduxsaga color="#A67153" fill="#A67153" className="mr-2" />
                  <DiWordpress className="mr-2" />
                  <DiRubyRough color="#A67153" fill="#A67153" className="mr-2" />
              ...
              <div className="w-2/4 ml-8" data-aos="zoom-in-up">
                ...
                <div className="tech-container flex flex-row text-3xl mt-4 mb-8">
                  <SiPostman color="#A67153" fill="#A67153" className="mr-4" />
