...
const Projects = () => {
  ...
  return (
    <div className="relative flex flex-col h-119 mt-0 text-para content-center pt-14" id="Projects">
      <div className="st-section-heading st-style1 ">
        <h4 className="st-section-heading-title" data-aos="fade-down">WORK</h4>
        <h2 className="st-section-heading-subtitle">WORK</h2>
      </div>
      <blockquote className="text-base md:lg:xl:text-lg italic font-Bodoni mt-10 tracking-wide  w-2/4 mx-auto" data-aos="fade-right">
